...
export function StagePerfectPage() {
  ...
  return <main className="stage-page perfect-stage" dir="rtl"><AmbientBackground /><header className="stage-header"><Wordmark /><div><StatusPill tone="gold"><Clock3 size={16} /> الثانية المثالية</StatusPill><span>جماعة العلوم الزراعية والبحرية</span></div></header>
